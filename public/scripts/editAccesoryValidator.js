...
const $formEditAccesory = document.querySelector('#formEditAccesory');
const $submitError = document.querySelector('#submitError');
const $inputs = document.querySelectorAll('#formEditAccesory input');
...
$formEditAccesory.addEventListener('submit', e => {
